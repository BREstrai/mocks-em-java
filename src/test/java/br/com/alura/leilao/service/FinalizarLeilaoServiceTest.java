...
class FinalizarLeilaoServiceTest {
    ...
    void deveriaFinalizarLeiloesExpirados() {
        ...
        Assert.assertEquals(new BigDecimal("800"), leilao.getLanceVencedor().getValor());
    ...
    void deveriaEnviarEmailParaVencedorLeilao() {
        ...
        Assert.assertEquals(new BigDecimal("800"), lanceVencedor.getValor());

        Mockito.verify(enviadorDeEmails).enviarEmailVencedorLeilao(lanceVencedor);
    }

    @Test
    void naoDeveriaEnviarEmailParaVencedorLeilaoEmCasoDeErroAoFinalizarLeilao() {
        List<Leilao> leiloes = leiloes();
